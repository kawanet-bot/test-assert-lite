...
test("assert surface", () => {
    ...
    assert.equal(typeof m.sharedTAL.assert.strict.deepEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.notDeepEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.strictEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.notStrictEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.deepStrictEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.notDeepStrictEqual, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.throws, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.doesNotThrow, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.rejects, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.doesNotReject, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.match, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.doesNotMatch, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.ifError, "function")
    assert.equal(typeof m.sharedTAL.assert.strict.fail, "function")
})
